Projet simple visant à lister des cartes Yugioh. Lorsque l'on clique sur l'une d'elle on a accès au informations détaillé de la carte (ces dernières sont résumés sur l'image de la carte)
